...
本文使用了两种纠错码，Turbo码和BCH码。

\subsubsection{Turbo码}

Turbo码于1993年由Claude Berrou等人提出，其实现方式以时间换取逼近香农极限的性能。Turbo码的编码器和解码器如图\ref{turbo_encode}和\ref{turbo_decode}所示。
