...
\begin{document}
\categorynumber{TN918.91} % 分类采用《中国图书资料分类法》
\UDC{004}            %《国际十进分类法UDC》的类号
\secretlevel{公开}    %学位论文密级分为"公开"、"内部"、"秘密"和"机密"四种
\studentid{170819}   %学号要完整，前面的零不能省略。
...
\author{袁瑞}{Rui Yuan}
\advisor{彭林宁}{}{Linning Peng}{Associate Prof.}
% \coadvisor{彭林宁}{副研究员}{Linning Peng}{Associate Prof.}
