...
本文选择NIST随机性测试中的7种随机性测试方法计算不同场景下生成密钥的随机性。本文分别计算了降采样率为1、4、8时的测试结果，分别如表\ref{NIST_test_result_1}、\ref{NIST_test_result_4}、\ref{NIST_test_result_8}所示。

% \begin{table}[]
%     \centering
%     \setlength{\tabcolsep}{0.06mm}{
%     \begin{tabular}{12cm}{cccccccccc} 
%         \toprule
...
%         \midrule
%         频率检验 & 0.1153    & 0.1265    & 0.0594    & 0.0367    & 0.0120    & 0.0683    & 0.0274    & 0.1252    & 0.0410 \\
%         块内频数检验 & \underline{0.0000}    & 0.0702    & 0.1575    & \underline{0.0009}    & 0.0109    & 0.0257    & \underline{0.0044}    & \underline{0.0081}    & 0.0149 \\
%         游程检验 & 0.5701    & \underline{0.0081}    & \underline{0.0048}    & 0.0721    & \underline{0.0033}    & 0.0257    & 0.0106    & 0.0167    & 0.0130 \\
%         块内最长游程检验 & \underline{0.0000}    & \underline{0.0000}    & \underline{0.0006}    & \underline{0.0000}    & \underline{0.0000}    & \underline{0.0000}    & \underline{0.0000}    & \underline{0.0006}    & \underline{0.0006} \\
%         % 二元矩阵秩检验 & 0.9953    & 0.9787    & 0.9352    & 0.9949    & 0.9978    & 0.9812    & 0.9994    & 0.9734    & 0.9689 \\
%         序列检验 & 0.2056    & \underline{0.0029}    & \underline{0.0042}    & 0.0214    & \underline{0.0011}    & 0.0163    & \underline{0.0044}    & 0.0112    & \underline{0.0087} \\
%         近似熵检验 & 0.2165    & \underline{0.0023}    & \underline{0.0055}    & 0.0219    & \underline{0.0011}    & 0.0157    & \underline{0.0050}    & 0.0112    & \underline{0.0087} \\
%         累加和检验 & 0.7804    & 0.7734    & 0.6578    & 0.6346    & 0.6663    & 0.7323    & 0.7573    & 0.8240    & 0.7646 \\
%         \bottomrule
%     \end{tabular}
%     }
...
%         \textbf{室外-方式1} & \textbf{室外-方式2} & \textbf{室外-方式3} \\
%         \midrule
%         频率检验 & 0.0933    & 0.3617    & 0.2133    & 0.1433    & 0.3967    & 0.2367    & 0.2283    & 0.1517    & 0.2033 \\
%         块内频数检验 & 0.4233    & 0.6783    & 0.8567    & 0.8800    & 0.1967    & 0.7767    & 0.7750    & 0.5967    & 0.7383 \\
%         游程检验 & \underline{0.0083}    & 0.1883    & 0.0783    & 0.0467    & 0.6433    & 0.1383    & 0.1167    & 0.1583    & 0.1483 \\
%         块内最长游程检验 & \underline{0.0067}    & \underline{0.0083}    & 0.0233    & 0.0183    & 0.0233    & 0.0817    & \underline{0.0067}    & 0.1183    & 0.0583 \\
%         % 二元矩阵秩检验 & 0.9750    & 0.9533    & 0.8683    & 0.9283    & 0.9783    & 0.8767    & 0.9950    & 0.8983    & 0.9200 \\
%         序列检验 & \underline{0.0000}    & 0.0867    & 0.0450    & 0.0367    & 0.3150    & 0.0800    & 0.0367    & 0.0733    & 0.0717 \\
%         近似熵检验 & \underline{0.0000}    & 0.0733    & 0.0500    & 0.0350    & 0.3867    & 0.0833    & 0.0367    & 0.0700    & 0.0583 \\
%         累加和检验 & 0.9050    & 0.8950    & 0.8617    & 0.8017    & 0.8017    & 0.9083    & 0.8817    & 0.9533    & 0.9000 \\
...
\begin{table}[]
    ...
    \begin{tabu}to \linewidth{X[c,m]X[c,m]X[c,m]X[c,m]X[c,m]X[c,m]X[c,m]X[c,m]X[c,m]X[c,m]}
        ...
        \textbf{室外-方式1} & \textbf{室外-方式2} & \textbf{室外-方式3} \\
        \midrule
        频率检验 & 0.3200    & 0.6333    & 0.5450    & 0.5567    & 0.6550    & 0.4900    & 0.5800    & 0.3050    & 0.4150  \\
        块内频数检验 & 0.9950    & 0.9967    & 0.9867    & 0.9917    & 0.9950    & 0.9917    & 1.0000    & 0.9933    & 0.9967 \\
        游程检验 & 0.1783    & 0.3933    & 0.1850    & 0.1617    & 0.8017    & 0.4200    & 0.2950    & 0.4683    & 0.3817 \\
        块内最长游程检验 & 0.7017    & 0.4250    & 0.2500    & 0.2650    & 0.9100    & 0.4883    & 0.4217    & 0.7667    & 0.5483 \\
        % 二元矩阵秩检验 & 0.0000    & 0.0000    & 0.0000    & 0.0000    & 0.0000    & 0.0000    & 0.0000    & 0.0000    & 0.0000 \\
        序列检验 & 0.0317    & 0.3000    & 0.1250    & 0.1117    & 0.6300    & 0.2667    & 0.1967    & 0.2250    & 0.2350 \\
        近似熵检验 & 0.0117    & 0.3050    & 0.1133    & 0.0950    & 0.6450    & 0.2317    & 0.1733    & 0.2067    & 0.2133 \\
        累加和检验 & 1.0000    & 0.9800    & 0.9850    & 0.9867    & 0.9917    & 0.9883    & 0.9950    & 0.9950    & 0.9950 \\
